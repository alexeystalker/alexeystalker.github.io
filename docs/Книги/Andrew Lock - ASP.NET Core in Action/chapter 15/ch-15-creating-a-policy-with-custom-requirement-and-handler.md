...
![[../../../images/Pasted image 20220621191024.png|Pasted image 20220621191024.png]]
...
Обычно, требования — это просто [[../../../Определения/poco-class|POCO]]-классы. Например, `AllowedInLoungeRequirement` может вообще не иметь методов или свойств:
```csharp
